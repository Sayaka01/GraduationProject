...
void SceneGame::PlayerInitialize()
{
	...
	player->AddComponent(new CapsuleCollider());//Player Componentより先につける

	player->AddComponent(new SphereCollider("RightHand"));//Player Componentより先につける
	player->AddComponent(new SphereCollider("LeftHand"));//Player Componentより先につける
