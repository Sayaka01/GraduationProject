...
public:
	...
	static const GamePadButton BTN_LEFT_TRIGGER	    = (1 << 12);
	static const GamePadButton BTN_RIGHT_TRIGGER	    = (1 << 13);
	static const GamePadButton BTN_LEFT_SHOULDER	= (1 << 14);
	static const GamePadButton BTN_RIGHT_SHOULDER	= (1 << 15);
...
public:
	...
	//振動
	bool SetVibration(float r, float l, float vibTimer);
